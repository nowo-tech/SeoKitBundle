...
final readonly class PageHeadResolver
{
    ...
    public function resolve(PageHeadInput $input): PageHead
    {
        ...
        $title    = $this->titleComposer instanceof PageHeadTitleComposerInterface
        ...
        return new PageHead(
            ...
            ogImage: $ogImage,
            ogImageWidth: $ogImage === null ? null : $defaults->ogImageWidth,
            ogImageHeight: $ogImage === null ? null : $defaults->ogImageHeight,
            ogLocale: $this->openGraphLocale($input->locale),
            ogLocaleAlternates: $this->openGraphAlternates($input->locale, $hreflang),
            twitterCard: $ogImage === null ? 'summary' : 'summary_large_image',
